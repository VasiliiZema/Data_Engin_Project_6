...
df_optimized.to_csv("CIS_Automotive_Kaggle_Sample_optimizired.csv")

#!!!!!!!
memory_stat_dataset(df_original, file_name_csv,  "memory_info_data_orijinal.json")
#!!!!!!!
memory_stat_dataset(df_optimized, "CIS_Automotive_Kaggle_Sample_optimizired.csv",  "memory_info_data_optimizired.json")
...
columns_name = ["color", "msrp", "brandName", "modelName", "stockNum", "vf_BatteryA",
             "vf_BasePrice", "vf_TopSpeedMPH", "vf_TrackWidth", "vf_TrailerLength"]
